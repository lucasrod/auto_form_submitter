...
(function(factory){
    if(typeof define === 'function' && define.amd){
        ...
        define(['scrapped_htm/alta demanda_files/jquery'], factory);
        ...
        module.exports = function(root, jQuery){
            if(jQuery === undefined){
                ...
                if(typeof window !== 'undefined'){
                    jQuery = require('scrapped_htm/alta demanda_files/jquery');
                }
                else{
                    jQuery = require('scrapped_htm/alta demanda_files/jquery')(root);
                }
            }
            factory(jQuery);
            return jQuery;
